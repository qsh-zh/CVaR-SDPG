...
class CheetahWrapper(EnvWrapper):
    def __init__(self, env_name):  
...
class ReacherWrapper(EnvWrapper):
    def __init__(self, env_name):  
...
class HopperWrapper(EnvWrapper):
    def __init__(self, env_name):  
...
class SwimmerWrapper(EnvWrapper):
    def __init__(self, env_name):  
...
class Walker2dWrapper(EnvWrapper):
    def __init__(self, env_name):  
...
class InvertedPendulumWrapper(EnvWrapper):
    def __init__(self, env_name):  
...
class HumanoidWrapper(EnvWrapper):
    def __init__(self, env_name):  
...
class CarRancingWrapper(EnvWrapper):
    def __init__(self, env_name):  
