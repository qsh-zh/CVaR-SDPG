...
class train_params:
    ...
    ENV = 'Humanoid-v2' #'Walker2d-v2'                     # Environment to use (must have low dimensional state space (i.e. not image) and continuous action space)
    ...
    REPLAY_MEM_SIZE = 1500000       # Soft maximum capacity of replay memory
    ...
    CVaR_alpha = 0.250                    # CVar coefficient
    WANG_SEEKING = 0.0
    WANG_AVERSING = 0.0
