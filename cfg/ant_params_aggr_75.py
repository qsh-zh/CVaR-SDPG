...
class train_params:
    ...
    ENV = 'Ant-v2' #'Walker2d-v2'                     # Environment to use (must have low dimensional state space (i.e. not image) and continuous action space)
    ...
    CVaR_optimizing = True          
    CVaR_alpha = 0.750                    # CVar coefficient
    WANG_SEEKING = 0.0
    WANG_AVERSING = 0.0
